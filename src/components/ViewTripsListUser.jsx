...
function ViewTripsListUser({ user }) {
        ...
        <tbody>
          {trips.map(trip => (
            <tr key={trip.tripName}>
              ...
              <button className="btn btn-primary" onClick={() => handleAssignTrip(trip.tripName)}>
                {trip.isUserSignedUp ? 'Afmeld' : 'Tilmeld'}
              </button>
...
export default ViewTripsListUser;
